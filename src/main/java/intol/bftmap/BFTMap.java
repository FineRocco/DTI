...
public class BFTMap<K, V> implements Map<K, V> {
    ...
    public V remove(Object key) {
        ...
        try {
            BFTMapMessage<K,V> response = BFTMapMessage.fromBytes(rep);
            System.out.println("Removed successfully" + response.getValue().toString());
            return response.getValue();
        } catch (ClassNotFoundException | IOException ex) {
    ...
    public boolean containsKey(Object key) {
        throw new UnsupportedOperationException("Y to implement this method :)");
    }
    ...
    @Override
    public void clear() {
        throw new UnsupportedOperationException("You ar to implement this method :)");
    }

    @Override
    public boolean containsValue(Object value) {
        throw new UnsupportedOperationException("You are suppois method :)");
    }

    @Override
    public void putAll(Map<? extends K, ? extends V> m) {
        throw new UnsupportedOperationException("You are sd to implement this method :)");
    }

    @Override
    public Collection<V> values() {
        throw new UnsupportedOperationException("You are supposed to implement tod :)");
    }

    @Override
    public Set<Entry<K, V>> entrySet() {
        throw new UnsupportedOperationException("You are supposed to is method :)");
    }
}
